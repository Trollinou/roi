( function () {
	document.addEventListener( 'DOMContentLoaded', function () {
		...
		function updateActiveMove() {
			...
			if (
				boardAPI.boardState &&
				boardAPI.boardState.historyViewerState &&
				boardAPI.boardState.historyViewerState.isEnabled
			) {
		...
		function setupControls() {
			const prevStartBtn =
				document.getElementById( 'roi-prev-start-btn' );
			...
			if ( nextBtn ) {
				nextBtn.addEventListener( 'click', function () {
					...
					if (
						...
						currentPly =
							boardAPI.boardState.historyViewerState.plyViewing;
					} else {
						currentPly = boardAPI.getCurrentPlyNumber();
					}
					const history = boardAPI.getHistory( true );
