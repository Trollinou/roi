(function(wp) {
    ...
    // ========================================
    registerBlockType('roi/chessboard', {
        title: __('Échiquier', 'roi'),
        icon: 'grid-view',
        category: 'widgets',
        description: __('Insérer un échiquier interactif', 'roi'),
        ...
        edit: function(props) {
            ...
            return el('div', { className: 'wp-block-roi-chessboard' },
                el(InspectorControls, {},
                    el(PanelBody, { title: __('Configuration', 'roi') },
                        el(TextControl, {
                    ...
                    el(PanelBody, { title: __('Mode de jeu', 'roi') },
                        el(ToggleControl, {
                        ...
                        isEngineEnabled && el(SelectControl, {
                        ...
                        isEngineEnabled && el(RangeControl, {
                            label: __('Niveau', 'roi'),
