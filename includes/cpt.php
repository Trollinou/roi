...
/**
 * Register the Partie CPT.
 *
 * This function defines and registers the 'roi_partie' custom post type for chess games played in PWA.
 *
 * @since 1.0.7
 * @return void
 */
function roi_register_partie_cpt() {
    $labels = array(
...
add_action( 'init', 'roi_register_partie_cpt', 0 );
