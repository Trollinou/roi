...
class TypeQuiSuisJe implements TypeInterface {
	...
	public function render( \WP_Post $post, array $config_data ): void {
		$indices       = isset( $config_data['indices'] ) && is_array( $config_data['indices'] ) ? $config_data['indices'] : array();
		...
		$reponse_qcm   = isset( $config_data['reponse_qcm'] ) && is_array( $config_data['reponse_qcm'] ) ? $config_data['reponse_qcm'] : array();

		$qcm_choix         = isset( $reponse_qcm['choix'] ) && is_array( $reponse_qcm['choix'] ) ? $reponse_qcm['choix'] : array();
