...
class Chapitre_Taxonomy {
	...
	public function init(): void {
		...
		add_filter( 'get_terms', array( $this, 'trier_termes_chapitre' ), 10, 3 );
		add_filter( 'wp_terms_checklist_args', array( $this, 'args_checklist_chapitre' ), 10, 2 );
	}
	...
	public function register(): void {
		...
		$args = array(
			...
			'query_var'         => true,
			'rewrite'           => array( 'slug' => 'roi-chapitre' ),
			'show_in_rest'      => true,
			'capabilities'      => array(
