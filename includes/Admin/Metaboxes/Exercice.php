...
final class Exercice {
    ...
    /**
     * Force le chargement de l'éditeur pour les exercices.
     */
    public function enqueue_editor( string $hook ): void {
        global $post;
        if ( in_array( $hook, [ 'post.php', 'post-new.php' ], true ) && isset( $post->post_type ) && $post->post_type === 'roi_exercice' ) {
            wp_enqueue_editor();
        }
    }
    ...
    public function render_metabox( WP_Post $post ): void {
        ...
        <table class="form-table">
                ...
                <td>
                    ...
                    for ( $i = 0; $i < 5; $i++ ) :
                        ...
                        <div style="margin-bottom: 15px;">
                            ...
                            <input type="text" name="roi_answers[<?php echo $i; ?>][text]" id="roi_answer_text_<?php echo $i; ?>" value="<?php echo esc_attr( (string) $answer_text ); ?>" style="width: 80%;" />
            ...
            <tr>
                ...
                <td>
                    <?php
                    wp_editor( (string) $solution, 'roi_exercice_solution', [
